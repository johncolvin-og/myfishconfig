...
# Custom colors
set -U my_dark_gray 222222
set -U my_dark_gray2 333333
set -U my_semi_dark_gray 444444
set -U my_semi_dark_gray2 555555
set -U my_gray 666666
set -U my_semi_light_gray 999999
...
function __budspencer_prompt_left_symbols -d 'Display symbols'
    ...
    # set -l symbols (set_color -b $my_prompt_symbols_bg)''
    set -l symbols (set_color -b $my_prompt_symbols_bg)
    ...
    switch $pwd_style
        case none
            if test $symbols_urgent = T
                set symbols (set_color -b $my_prompt_symbols_bg)''(set_color normal)(set_color $my_prompt_symbols_bg)
            else
                set symbols ''
            end
    end
...
function __budspencer_pwd -d 'My twist on budspencer\'s working dir (but for the left prompt)'
  ...
  set_color -b $my_prompt_user_bg
  set_color -o $my_prompt_user_fg
  echo -n $USER

  set_color -b $my_prompt_at_bg
  set_color -o $my_prompt_at_fg
  echo -n '@'

  set_color -b $my_prompt_host_bg
